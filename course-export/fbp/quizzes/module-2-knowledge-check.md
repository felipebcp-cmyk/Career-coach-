# Module 2 — From Analysis to Influence: knowledge check

Pass mark: 80%. Correct answers are **bold**.

**1. 'Travel spend is 12% over budget' is best described as:**
...
**2. The best place for your conclusion when presenting to executives is:**
...
**3. In situation–complication–resolution, the 'complication' is:**
...
**4. 'EBITDA margin compression from adverse mix' said to an ops leader should become:**
...
**5. A stakeholder always asks for the bottom line and gets impatient with detail. You should:**
...
**6. Which pairing of comparison and chart is correct?**
...
**7. The best title for a chart showing churn concentrated in the 2024 cohort is:**
...
**8. How should significant bad news reach a stakeholder first?**
...
**9. Influence without authority rests on:**
...
**10. Why socialise a big recommendation one-to-one before the formal meeting?**
