# Module 2 — The Five Levers of Attention and Persuasion: knowledge check

Pass mark: 80%. Correct answers are **bold**.

**1. Your audience complains constantly about the problem but has never heard that solutions exist. Your first message should:**
...
**2. The 'most aware' segment of an audience needs:**
...
**3. Why does naming a problem with uncomfortable precision persuade?**
...
**4. 'Attention: freelancers' underperforms 'You've finished the work — now comes the part you hate: asking to be paid' because:**
...
**5. The right sequence for mirror and exclusion is:**
...
**6. 'This isn't for beginners' versus mocking beginners — the difference matters because:**
...
**8. The better transformation line is:**
...
**10. The five levers in working order are:**
