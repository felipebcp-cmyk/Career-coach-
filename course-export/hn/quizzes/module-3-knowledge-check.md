# Module 3 — Influence in Practice: Ethics, Reality and Mastery: knowledge check

Pass mark: 80%. Correct answers are **bold**.

**1. The clearest line between persuasion and manipulation is:**
...
**2. Why does managing your own needs matter ethically?**
...
**3. 'Untested knowledge is a hypothesis wearing a diploma' argues that:**
...
**4. Your post got attention and agreement but nobody acted. The most likely failed lever is:**
...
**5. In a negotiation, the other party keeps returning to how the deal will look to their board. Their active tension is:**
...
**6. Translating one proposal into 'stops the bleeding' for one listener and 'the first step toward your stated goal' for another is:**
...
**7. Why does the 'meta-skill' argument say human nature outlasts specific hot skills?**
...
**8. An A/B test shows your most fear-heavy headline converts best — followed by high refunds and churn. The right conclusion is:**
